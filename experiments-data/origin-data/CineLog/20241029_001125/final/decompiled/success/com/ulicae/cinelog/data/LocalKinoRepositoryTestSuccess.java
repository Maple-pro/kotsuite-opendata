...
public class LocalKinoRepositoryTestSuccess {
   ...
   public void test_findAllByRating_boolean_1_2417() {
      List var1 = ((LocalKinoRepository)JMockK.spyk(new LocalKinoRepository((DaoSession)JMockK.mockk(DaoSession.class, true)))).findAllByRating(true);
   }

   @Test
   public void test_findAllByRating_boolean_2_2421() {
   ...
   public void test_findAllByReviewDate_boolean_1_2441() {
      List var1 = ((LocalKinoRepository)JMockK.spyk(new LocalKinoRepository((DaoSession)JMockK.mockk(DaoSession.class, true)))).findAllByReviewDate(true);
   }
   ...
   public void test_findAllByYear_boolean_1_2429() {
      List var1 = ((LocalKinoRepository)JMockK.spyk(new LocalKinoRepository((DaoSession)JMockK.mockk(DaoSession.class, true)))).findAllByYear(true);
   }

   @Test
   public void test_findByMovieId_long_1_2405() {
      LocalKino var1 = ((LocalKinoRepository)JMockK.spyk(new LocalKinoRepository((DaoSession)JMockK.mockk(DaoSession.class, true)))).findByMovieId(-92L);
   }
}
