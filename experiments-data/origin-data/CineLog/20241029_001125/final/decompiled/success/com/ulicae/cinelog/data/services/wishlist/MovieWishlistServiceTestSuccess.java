...
public class MovieWishlistServiceTestSuccess {
   ...
   public void test_getWithTmdbId_long_1_3257() {
      WishlistDataDto var1 = ((MovieWishlistService)JMockK.spyk(new MovieWishlistService((DaoSession)JMockK.mockk(DaoSession.class, true)))).getWithTmdbId(33L);
   }

   @Test
   public void test_getWithTmdbId_long_1_3317() {
      ItemDto var1 = ((MovieWishlistService)JMockK.spyk(new MovieWishlistService((DaoSession)JMockK.mockk(DaoSession.class, true)))).getWithTmdbId(-62L);
   }
}
