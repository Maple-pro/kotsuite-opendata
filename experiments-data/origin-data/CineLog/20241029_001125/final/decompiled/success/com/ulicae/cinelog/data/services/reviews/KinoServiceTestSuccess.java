...
public class KinoServiceTestSuccess {
   ...
   public void test_getKinosByRating_boolean_1_4217() {
      List var1 = ((KinoService)JMockK.spyk(new KinoService((DaoSession)JMockK.mockk(DaoSession.class, true)))).getKinosByRating(true);
   }

   @Test
   public void test_getKinosByReviewDate_boolean_1_4241() {
      List var1 = ((KinoService)JMockK.spyk(new KinoService((DaoSession)JMockK.mockk(DaoSession.class, true)))).getKinosByReviewDate(false);
   }
   ...
   public void test_getKinosByYear_boolean_1_4229() {
      List var1 = ((KinoService)JMockK.spyk(new KinoService((DaoSession)JMockK.mockk(DaoSession.class, true)))).getKinosByYear(true);
   }

   @Test
   public void test_getWithTmdbId_long_1_4205() {
      KinoDto var1 = ((KinoService)JMockK.spyk(new KinoService((DaoSession)JMockK.mockk(DaoSession.class, true)))).getWithTmdbId(32L);
   }

   @Test
   public void test_getWithTmdbId_long_1_4297() {
      ItemDto var1 = ((KinoService)JMockK.spyk(new KinoService((DaoSession)JMockK.mockk(DaoSession.class, true)))).getWithTmdbId(78L);
   }
}
