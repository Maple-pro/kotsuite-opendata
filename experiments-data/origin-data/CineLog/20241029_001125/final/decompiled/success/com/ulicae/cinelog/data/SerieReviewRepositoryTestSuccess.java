...
public class SerieReviewRepositoryTestSuccess {
   ...
   public void test_findAllByRating_boolean_1_3793() {
      List var1 = ((SerieReviewRepository)JMockK.spyk(new SerieReviewRepository((DaoSession)JMockK.mockk(DaoSession.class, true)))).findAllByRating(false);
   }

   @Test
   public void test_findAllByRating_boolean_2_3797() {
   ...
   public void test_findByMovieId_long_1_3781() {
      SerieReview var1 = ((SerieReviewRepository)JMockK.spyk(new SerieReviewRepository((DaoSession)JMockK.mockk(DaoSession.class, true)))).findByMovieId(74L);
   }
}
