...
public class WishlistMovieDaoTestFailed {
   ...
   public void test_queryDeep_String_String_1_2001() {
      List var1 = ((WishlistMovieDao)JMockK.spyk(new WishlistMovieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).queryDeep("-JIStOvIZTaebAPNnPGNigHvj6KZKm47xF94S3DDs7ZGZObzaj4nK589T4myvD3KkQAo5Tw3OGk6FrkDbdkgD", new String[]{""});
   }

   @Test
   public void test_readEntity_Cursor_Object_int_1_2045() {
      ((WishlistMovieDao)JMockK.spyk(new WishlistMovieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (Object)JMockK.mockk(Object.class, true), 24);
   }

   @Test
   public void test_readEntity_Cursor_WishlistMovie_int_1_1917() {
      ((WishlistMovieDao)JMockK.spyk(new WishlistMovieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (WishlistMovie)JMockK.mockk(WishlistMovie.class, true), -49);
   }

   @Test
   public void test_readEntity_Cursor_int_1_1901() {
      WishlistMovie var1 = ((WishlistMovieDao)JMockK.spyk(new WishlistMovieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), 33);
   }

   @Test
   public void test_readEntity_Cursor_int_1_2081() {
      Object var1 = ((WishlistMovieDao)JMockK.spyk(new WishlistMovieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), 61);
   }

   @Test
   public void test_readKey_Cursor_int_1_1885() {
      Long var1 = ((WishlistMovieDao)JMockK.spyk(new WishlistMovieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), 49);
   }

   @Test
   public void test_readKey_Cursor_int_1_2065() {
      Object var1 = ((WishlistMovieDao)JMockK.spyk(new WishlistMovieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), 25);
   }
}
