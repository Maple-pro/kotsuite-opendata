...
public class ReviewDaoTestFailed {
   ...
   public void test_readEntity_Cursor_Object_int_1_961() {
      ((ReviewDao)JMockK.spyk(new ReviewDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (Object)JMockK.mockk(Object.class, true), -90);
   }

   @Test
   public void test_readEntity_Cursor_Review_int_1_877() {
      ((ReviewDao)JMockK.spyk(new ReviewDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (Review)JMockK.mockk(Review.class, true), -76);
   }

   @Test
   public void test_readEntity_Cursor_int_1_861() {
      Review var1 = ((ReviewDao)JMockK.spyk(new ReviewDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -8);
   }

   @Test
   public void test_readEntity_Cursor_int_1_997() {
      Object var1 = ((ReviewDao)JMockK.spyk(new ReviewDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -12);
   }

   @Test
   public void test_readKey_Cursor_int_1_845() {
      Long var1 = ((ReviewDao)JMockK.spyk(new ReviewDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), 14);
   }

   @Test
   public void test_readKey_Cursor_int_1_981() {
      Object var1 = ((ReviewDao)JMockK.spyk(new ReviewDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), 31);
   }
}
