...
public class LayoutKinoItemBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_5941() {
      LayoutKinoItemBinding var1 = LayoutKinoItemBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), false);
   }
}
