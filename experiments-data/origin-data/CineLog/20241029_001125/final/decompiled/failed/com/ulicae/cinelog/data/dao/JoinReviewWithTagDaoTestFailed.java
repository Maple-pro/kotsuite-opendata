...
public class JoinReviewWithTagDaoTestFailed {
   ...
   public void test_readEntity_Cursor_JoinReviewWithTag_int_1_465() {
      ((JoinReviewWithTagDao)JMockK.spyk(new JoinReviewWithTagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (JoinReviewWithTag)JMockK.mockk(JoinReviewWithTag.class, true), 37);
   }

   @Test
   public void test_readEntity_Cursor_Object_int_1_549() {
      ((JoinReviewWithTagDao)JMockK.spyk(new JoinReviewWithTagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (Object)JMockK.mockk(Object.class, true), -81);
   }

   @Test
   public void test_readEntity_Cursor_int_1_449() {
      JoinReviewWithTag var1 = ((JoinReviewWithTagDao)JMockK.spyk(new JoinReviewWithTagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -3);
   }

   @Test
   public void test_readEntity_Cursor_int_1_585() {
      Object var1 = ((JoinReviewWithTagDao)JMockK.spyk(new JoinReviewWithTagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -58);
   }

   @Test
   public void test_readKey_Cursor_int_1_433() {
      Long var1 = ((JoinReviewWithTagDao)JMockK.spyk(new JoinReviewWithTagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), 79);
   }

   @Test
   public void test_readKey_Cursor_int_1_569() {
      Object var1 = ((JoinReviewWithTagDao)JMockK.spyk(new JoinReviewWithTagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), -67);
   }
}
