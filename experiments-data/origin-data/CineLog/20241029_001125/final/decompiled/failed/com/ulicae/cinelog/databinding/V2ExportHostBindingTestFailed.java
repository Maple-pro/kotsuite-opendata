...
public class V2ExportHostBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_5090() {
      V2ExportHostBinding var1 = V2ExportHostBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), true);
   }
}
