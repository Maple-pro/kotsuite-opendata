...
public class FragmentSearchTmdbBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_4545() {
      FragmentSearchTmdbBinding var1 = FragmentSearchTmdbBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), false);
   }

   @Test
   public void test_inflate_LayoutInflater_ViewGroup_boolean_2_4549() {
