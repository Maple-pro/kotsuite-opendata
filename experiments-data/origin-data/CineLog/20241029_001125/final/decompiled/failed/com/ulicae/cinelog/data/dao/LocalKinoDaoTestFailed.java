...
public class LocalKinoDaoTestFailed {
   ...
   public void test_queryDeep_String_String_1_733() {
      List var1 = ((LocalKinoDao)JMockK.spyk(new LocalKinoDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).queryDeep("dIc0oq4p6rz43TpKin64iy5alecki2Np0wmx1TK-VfthgorS7MyEKUukLpkKJw2a-BV3WHcvn+dTqebOYtqcWt8aW-Dn", new String[]{""});
   }

   @Test
   public void test_readEntity_Cursor_LocalKino_int_1_649() {
      ((LocalKinoDao)JMockK.spyk(new LocalKinoDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (LocalKino)JMockK.mockk(LocalKino.class, true), 24);
   }

   @Test
   public void test_readEntity_Cursor_Object_int_1_777() {
      ((LocalKinoDao)JMockK.spyk(new LocalKinoDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (Object)JMockK.mockk(Object.class, true), 99);
   }

   @Test
   public void test_readEntity_Cursor_int_1_633() {
      LocalKino var1 = ((LocalKinoDao)JMockK.spyk(new LocalKinoDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -84);
   }

   @Test
   public void test_readEntity_Cursor_int_1_813() {
      Object var1 = ((LocalKinoDao)JMockK.spyk(new LocalKinoDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), 47);
   }

   @Test
   public void test_readKey_Cursor_int_1_617() {
      Long var1 = ((LocalKinoDao)JMockK.spyk(new LocalKinoDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), -25);
   }

   @Test
   public void test_readKey_Cursor_int_1_797() {
      Object var1 = ((LocalKinoDao)JMockK.spyk(new LocalKinoDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), -26);
   }
}
