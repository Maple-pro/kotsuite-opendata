...
public class WishlistSearchResultItemBindingTestFailed {
   ...
   @Test
   public void test_inflate_LayoutInflater_ViewGroup_boolean_2_5917() {
      WishlistSearchResultItemBinding var1 = WishlistSearchResultItemBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), false);
   }
}
