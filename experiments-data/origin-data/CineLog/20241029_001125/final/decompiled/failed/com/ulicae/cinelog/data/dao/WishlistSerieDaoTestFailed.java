...
public class WishlistSerieDaoTestFailed {
   ...
   public void test_queryDeep_String_String_1_2229() {
      List var1 = ((WishlistSerieDao)JMockK.spyk(new WishlistSerieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).queryDeep("JErVmI1JmwkwM6ATK5Rbz67CdBX0dcVadakLnlFgPu1sWdIB+BeQu1ZmNW4q+ZobESllFCuG7BTcC2g", new String[]{""});
   }

   @Test
   public void test_readEntity_Cursor_Object_int_1_2273() {
      ((WishlistSerieDao)JMockK.spyk(new WishlistSerieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (Object)JMockK.mockk(Object.class, true), 58);
   }

   @Test
   public void test_readEntity_Cursor_WishlistSerie_int_1_2145() {
      ((WishlistSerieDao)JMockK.spyk(new WishlistSerieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (WishlistSerie)JMockK.mockk(WishlistSerie.class, true), -27);
   }

   @Test
   public void test_readEntity_Cursor_int_1_2129() {
      WishlistSerie var1 = ((WishlistSerieDao)JMockK.spyk(new WishlistSerieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -13);
   }

   @Test
   public void test_readEntity_Cursor_int_1_2309() {
      Object var1 = ((WishlistSerieDao)JMockK.spyk(new WishlistSerieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), 90);
   }

   @Test
   public void test_readKey_Cursor_int_1_2113() {
      Long var1 = ((WishlistSerieDao)JMockK.spyk(new WishlistSerieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), 84);
   }

   @Test
   public void test_readKey_Cursor_int_1_2293() {
      Object var1 = ((WishlistSerieDao)JMockK.spyk(new WishlistSerieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), 78);
   }
}
