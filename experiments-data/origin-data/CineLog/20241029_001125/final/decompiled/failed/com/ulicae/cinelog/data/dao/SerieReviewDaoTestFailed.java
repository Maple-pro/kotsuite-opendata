...
public class SerieReviewDaoTestFailed {
   ...
   public void test_queryDeep_String_String_1_1373() {
      List var1 = ((SerieReviewDao)JMockK.spyk(new SerieReviewDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).queryDeep("I1WheNoI53DZkfEWgctkmtDSA824c1J", new String[]{""});
   }

   @Test
   public void test_readEntity_Cursor_Object_int_1_1417() {
      ((SerieReviewDao)JMockK.spyk(new SerieReviewDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (Object)JMockK.mockk(Object.class, true), -61);
   }

   @Test
   public void test_readEntity_Cursor_SerieReview_int_1_1289() {
      ((SerieReviewDao)JMockK.spyk(new SerieReviewDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (SerieReview)JMockK.mockk(SerieReview.class, true), 0);
   }

   @Test
   public void test_readEntity_Cursor_int_1_1273() {
      SerieReview var1 = ((SerieReviewDao)JMockK.spyk(new SerieReviewDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -69);
   }

   @Test
   public void test_readEntity_Cursor_int_1_1453() {
      Object var1 = ((SerieReviewDao)JMockK.spyk(new SerieReviewDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -92);
   }

   @Test
   public void test_readKey_Cursor_int_1_1257() {
      Long var1 = ((SerieReviewDao)JMockK.spyk(new SerieReviewDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), 57);
   }

   @Test
   public void test_readKey_Cursor_int_1_1437() {
      Object var1 = ((SerieReviewDao)JMockK.spyk(new SerieReviewDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), -1);
   }
}
