...
public class FragmentSerieViewGeneralBindingTestFailed {
   ...
   @Test
   public void test_inflate_LayoutInflater_ViewGroup_boolean_2_5777() {
      FragmentSerieViewGeneralBinding var1 = FragmentSerieViewGeneralBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), false);
   }
}
