...
public class JoinLocalKinoWithTagDaoTestFailed {
   ...
   public void test_readEntity_Cursor_JoinLocalKinoWithTag_int_1_281() {
      ((JoinLocalKinoWithTagDao)JMockK.spyk(new JoinLocalKinoWithTagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (JoinLocalKinoWithTag)JMockK.mockk(JoinLocalKinoWithTag.class, true), -48);
   }

   @Test
   public void test_readEntity_Cursor_Object_int_1_365() {
      ((JoinLocalKinoWithTagDao)JMockK.spyk(new JoinLocalKinoWithTagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (Object)JMockK.mockk(Object.class, true), 77);
   }

   @Test
   public void test_readEntity_Cursor_int_1_265() {
      JoinLocalKinoWithTag var1 = ((JoinLocalKinoWithTagDao)JMockK.spyk(new JoinLocalKinoWithTagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -36);
   }

   @Test
   public void test_readEntity_Cursor_int_1_401() {
      Object var1 = ((JoinLocalKinoWithTagDao)JMockK.spyk(new JoinLocalKinoWithTagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -48);
   }

   @Test
   public void test_readKey_Cursor_int_1_249() {
      Long var1 = ((JoinLocalKinoWithTagDao)JMockK.spyk(new JoinLocalKinoWithTagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), -27);
   }

   @Test
   public void test_readKey_Cursor_int_1_385() {
      Object var1 = ((JoinLocalKinoWithTagDao)JMockK.spyk(new JoinLocalKinoWithTagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), 35);
   }
}
