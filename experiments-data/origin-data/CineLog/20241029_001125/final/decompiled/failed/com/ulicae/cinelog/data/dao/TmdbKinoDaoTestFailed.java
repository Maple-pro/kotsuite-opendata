...
public class TmdbKinoDaoTestFailed {
   ...
   public void test_readEntity_Cursor_Object_int_1_161() {
      ((TmdbKinoDao)JMockK.spyk(new TmdbKinoDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (Object)JMockK.mockk(Object.class, true), 79);
   }

   @Test
   public void test_readEntity_Cursor_TmdbKino_int_1_77() {
      ((TmdbKinoDao)JMockK.spyk(new TmdbKinoDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (TmdbKino)JMockK.mockk(TmdbKino.class, true), -29);
   }

   @Test
   public void test_readEntity_Cursor_int_1_197() {
      Object var1 = ((TmdbKinoDao)JMockK.spyk(new TmdbKinoDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -46);
   }

   @Test
   public void test_readEntity_Cursor_int_1_61() {
      TmdbKino var1 = ((TmdbKinoDao)JMockK.spyk(new TmdbKinoDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), 92);
   }

   @Test
   public void test_readKey_Cursor_int_1_181() {
      Object var1 = ((TmdbKinoDao)JMockK.spyk(new TmdbKinoDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), -65);
   }

   @Test
   public void test_readKey_Cursor_int_1_45() {
      Long var1 = ((TmdbKinoDao)JMockK.spyk(new TmdbKinoDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), 81);
   }
}
