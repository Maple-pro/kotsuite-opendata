...
public class SerieWishlistServiceTestSuccess {
   ...
   public void test_getWithTmdbId_long_1_3081() {
      WishlistDataDto var1 = ((SerieWishlistService)JMockK.spyk(new SerieWishlistService((DaoSession)JMockK.mockk(DaoSession.class, true)))).getWithTmdbId(57L);
   }

   @Test
   public void test_getWithTmdbId_long_1_3141() {
      ItemDto var1 = ((SerieWishlistService)JMockK.spyk(new SerieWishlistService((DaoSession)JMockK.mockk(DaoSession.class, true)))).getWithTmdbId(-85L);
   }
}
