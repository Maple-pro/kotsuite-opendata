...
public class WishlistMovieDaoTestSuccess {
   ...
   public void test_createTable_Database_boolean_1_1869() {
      WishlistMovieDao.createTable((Database)JMockK.mockk(Database.class, true), true);
   }

   @Test
   public void test_dropTable_Database_boolean_1_1877() {
      WishlistMovieDao.dropTable((Database)JMockK.mockk(Database.class, true), true);
   }

   @Test
   public void test_dropTable_Database_boolean_2_1880() {
