...
public class JoinReviewWithTagDaoTestSuccess {
   ...
   public void test_createTable_Database_boolean_1_417() {
      JoinReviewWithTagDao.createTable((Database)JMockK.mockk(Database.class, true), false);
   }

   @Test
   public void test_createTable_Database_boolean_2_420() {
   ...
   public void test_dropTable_Database_boolean_1_425() {
      JoinReviewWithTagDao.dropTable((Database)JMockK.mockk(Database.class, true), true);
   }
}
