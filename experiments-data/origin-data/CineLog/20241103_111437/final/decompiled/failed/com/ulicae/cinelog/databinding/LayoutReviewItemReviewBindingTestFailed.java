...
public class LayoutReviewItemReviewBindingTestFailed {
   ...
   @Test
   public void test_inflate_LayoutInflater_ViewGroup_boolean_2_5721() {
      LayoutReviewItemReviewBinding var1 = LayoutReviewItemReviewBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), false);
   }
}
