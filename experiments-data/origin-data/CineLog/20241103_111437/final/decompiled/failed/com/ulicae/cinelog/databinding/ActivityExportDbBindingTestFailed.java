...
public class ActivityExportDbBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_4994() {
      ActivityExportDbBinding var1 = ActivityExportDbBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), true);
   }

   @Test
   public void test_inflate_LayoutInflater_ViewGroup_boolean_2_4998() {
