...
public class TmdbSerieDaoTestFailed {
   ...
   public void test_readEntity_Cursor_Object_int_1_1817() {
      ((TmdbSerieDao)JMockK.spyk(new TmdbSerieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (Object)JMockK.mockk(Object.class, true), -54);
   }

   @Test
   public void test_readEntity_Cursor_TmdbSerie_int_1_1733() {
      ((TmdbSerieDao)JMockK.spyk(new TmdbSerieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (TmdbSerie)JMockK.mockk(TmdbSerie.class, true), 57);
   }

   @Test
   public void test_readEntity_Cursor_int_1_1717() {
      TmdbSerie var1 = ((TmdbSerieDao)JMockK.spyk(new TmdbSerieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -94);
   }

   @Test
   public void test_readEntity_Cursor_int_1_1853() {
      Object var1 = ((TmdbSerieDao)JMockK.spyk(new TmdbSerieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -79);
   }

   @Test
   public void test_readKey_Cursor_int_1_1701() {
      Long var1 = ((TmdbSerieDao)JMockK.spyk(new TmdbSerieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), -31);
   }

   @Test
   public void test_readKey_Cursor_int_1_1837() {
      Object var1 = ((TmdbSerieDao)JMockK.spyk(new TmdbSerieDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), -43);
   }
}
