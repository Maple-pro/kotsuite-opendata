...
public class ReviewListItemRowBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_5605() {
      ReviewListItemRowBinding var1 = ReviewListItemRowBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), false);
   }
}
