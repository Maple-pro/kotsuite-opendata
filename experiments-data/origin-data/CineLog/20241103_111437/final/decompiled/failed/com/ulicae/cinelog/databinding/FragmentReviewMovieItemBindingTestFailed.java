...
public class FragmentReviewMovieItemBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_5689() {
      FragmentReviewMovieItemBinding var1 = FragmentReviewMovieItemBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), true);
   }
}
