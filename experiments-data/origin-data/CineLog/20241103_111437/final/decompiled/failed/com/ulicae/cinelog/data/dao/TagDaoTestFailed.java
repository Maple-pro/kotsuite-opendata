...
public class TagDaoTestFailed {
   ...
   public void test_readEntity_Cursor_Object_int_1_1633() {
      ((TagDao)JMockK.spyk(new TagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (Object)JMockK.mockk(Object.class, true), -60);
   }

   @Test
   public void test_readEntity_Cursor_Tag_int_1_1517() {
      ((TagDao)JMockK.spyk(new TagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (Tag)JMockK.mockk(Tag.class, true), -60);
   }

   @Test
   public void test_readEntity_Cursor_int_1_1501() {
      Tag var1 = ((TagDao)JMockK.spyk(new TagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), 35);
   }

   @Test
   public void test_readEntity_Cursor_int_1_1669() {
      Object var1 = ((TagDao)JMockK.spyk(new TagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), 35);
   }

   @Test
   public void test_readKey_Cursor_int_1_1485() {
      Long var1 = ((TagDao)JMockK.spyk(new TagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), 70);
   }

   @Test
   public void test_readKey_Cursor_int_1_1653() {
      Object var1 = ((TagDao)JMockK.spyk(new TagDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), -82);
   }
}
