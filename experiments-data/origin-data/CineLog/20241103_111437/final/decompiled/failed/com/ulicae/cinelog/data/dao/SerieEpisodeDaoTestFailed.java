...
public class SerieEpisodeDaoTestFailed {
   ...
   public void test_queryDeep_String_String_1_1145() {
      List var1 = ((SerieEpisodeDao)JMockK.spyk(new SerieEpisodeDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).queryDeep("us", new String[]{""});
   }

   @Test
   public void test_readEntity_Cursor_Object_int_1_1189() {
      ((SerieEpisodeDao)JMockK.spyk(new SerieEpisodeDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (Object)JMockK.mockk(Object.class, true), 55);
   }

   @Test
   public void test_readEntity_Cursor_SerieEpisode_int_1_1061() {
      ((SerieEpisodeDao)JMockK.spyk(new SerieEpisodeDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), (SerieEpisode)JMockK.mockk(SerieEpisode.class, true), 76);
   }

   @Test
   public void test_readEntity_Cursor_int_1_1045() {
      SerieEpisode var1 = ((SerieEpisodeDao)JMockK.spyk(new SerieEpisodeDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -40);
   }

   @Test
   public void test_readEntity_Cursor_int_1_1225() {
      Object var1 = ((SerieEpisodeDao)JMockK.spyk(new SerieEpisodeDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readEntity((Cursor)JMockK.mockk(Cursor.class, true), -85);
   }

   @Test
   public void test_readKey_Cursor_int_1_1029() {
      Long var1 = ((SerieEpisodeDao)JMockK.spyk(new SerieEpisodeDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), -7);
   }

   @Test
   public void test_readKey_Cursor_int_1_1209() {
      Object var1 = ((SerieEpisodeDao)JMockK.spyk(new SerieEpisodeDao((DaoConfig)JMockK.mockk(DaoConfig.class, true)))).readKey((Cursor)JMockK.mockk(Cursor.class, true), 4);
   }
}
