...
public class WishlistItemBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_5549() {
      WishlistItemBinding var1 = WishlistItemBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), false);
   }
}
