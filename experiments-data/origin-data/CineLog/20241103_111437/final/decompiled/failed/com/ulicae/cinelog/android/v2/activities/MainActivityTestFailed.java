...
public class MainActivityTestFailed {
   ...
   public void test_goToTmdbMovieSearch_boolean_1_6017() {
      ((MainActivity)JMockK.spyk(new MainActivity())).goToTmdbMovieSearch(false);
   }
   ...
   public void test_navigateToItem_KinoDto_int_boolean_boolean_1_6069() {
      ((MainActivity)JMockK.spyk(new MainActivity())).navigateToItem((KinoDto)JMockK.mockk(KinoDto.class, true), -14, true, false);
   }

   @Test
   public void test_navigateToReview_KinoDto_boolean_int_1_6081() {
      ((MainActivity)JMockK.spyk(new MainActivity())).navigateToReview((KinoDto)JMockK.mockk(KinoDto.class, true), true, 97);
   }

   @Test
   public void test_navigateToWishlistItem_WishlistDataDto_int_1_6093() {
      ((MainActivity)JMockK.spyk(new MainActivity())).navigateToWishlistItem((WishlistDataDto)JMockK.mockk(WishlistDataDto.class, true), -62);
   }
}
