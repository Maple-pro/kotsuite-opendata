...
public class ModActivityTestFailed {
   ...
   public void test_setDelayValue_int_1_4129() {
      ((ModActivity)JMockK.spyk(new ModActivity())).setDelayValue(24);
   }

   @Test
   public void test_setEnableToggle_boolean_1_4137() {
      ((ModActivity)JMockK.spyk(new ModActivity())).setEnableToggle(true);
   }
   ...
   public void test_setNotificationEnabled_boolean_1_4153() {
      ((ModActivity)JMockK.spyk(new ModActivity())).setNotificationEnabled(false);
   }
   ...
   public void test_showDetectorCount_int_int_1_4113() {
      ((ModActivity)JMockK.spyk(new ModActivity())).showDetectorCount(-25, 39);
   }
