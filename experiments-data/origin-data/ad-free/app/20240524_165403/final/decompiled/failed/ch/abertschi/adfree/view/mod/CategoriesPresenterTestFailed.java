...
public class CategoriesPresenterTestFailed {
   ...
   public void test_onCategorySelected_String_1_4405() {
      ((CategoriesPresenter)JMockK.spyk(new CategoriesPresenter((CategoriesActivity)JMockK.mockk(CategoriesActivity.class, true)))).onCategorySelected("4sEVM4ca2OE+xR514Mhdf45mmRljf4rDPi4-Ph");
   }
