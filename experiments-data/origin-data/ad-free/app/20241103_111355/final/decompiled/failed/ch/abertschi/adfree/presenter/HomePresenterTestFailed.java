...
public class HomePresenterTestFailed {
   ...
   public void test_getLoggerTag_1_2797() {
      String var1 = ((HomePresenter)JMockK.spyk(new HomePresenter((HomeView)JMockK.mockk(HomeView.class, true), (PreferencesFactory)JMockK.mockk(PreferencesFactory.class, true), (RemoteManager)JMockK.mockk(RemoteManager.class, true)))).getLoggerTag();
   }
