...
public class AdDetectorTestFailed {
   @Test
   ...
   public void test_getLoggerTag_1_757() {
      String var1 = ((AdDetector)JMockK.spyk(new AdDetector((AdDetectableFactory)JMockK.mockk(AdDetectableFactory.class, true), (RemoteManager)JMockK.mockk(RemoteManager.class, true)))).getLoggerTag();
   }
