...
public class AccessPointDetailTestFailed {
   ...
   public void test_makeView_View_ViewGroup_WiFiDetail_boolean_int_1_2844() {
      View var1 = ((AccessPointDetail)JMockK.spyk(new AccessPointDetail())).makeView((View)JMockK.mockk(View.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), (WiFiDetail)JMockK.mockk(WiFiDetail.class, true), false, -24);
   }
}
