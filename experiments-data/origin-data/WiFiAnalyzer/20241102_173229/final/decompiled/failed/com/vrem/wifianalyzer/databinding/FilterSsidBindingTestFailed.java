...
public class FilterSsidBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_93() {
      FilterSsidBinding var1 = FilterSsidBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), true);
   }

   @Test
   public void test_inflate_LayoutInflater_ViewGroup_boolean_2_97() {
