...
public class InfoThrottlingBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_65() {
      InfoThrottlingBinding var1 = InfoThrottlingBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), true);
   }
}
