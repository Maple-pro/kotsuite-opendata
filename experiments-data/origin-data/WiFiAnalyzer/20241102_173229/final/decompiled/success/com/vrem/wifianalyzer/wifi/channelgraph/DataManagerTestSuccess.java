...
public class DataManagerTestSuccess {
   ...
   public void test_addSeriesData_GraphViewWrapper_Set_int_1_4944() {
      ((DataManager)JMockK.spyk(new DataManager())).addSeriesData((GraphViewWrapper)JMockK.mockk(GraphViewWrapper.class, true), (Set)JMockK.mockk(Set.class, true), -61);
   }

   @Test
   public void test_graphDataPoints_WiFiDetail_int_1_4932() {
      GraphDataPoint[] var1 = ((DataManager)JMockK.spyk(new DataManager())).graphDataPoints((WiFiDetail)JMockK.mockk(WiFiDetail.class, true), -23);
   }
