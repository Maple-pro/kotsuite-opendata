...
public class AccessPointViewPopupBindingTestFailed {
   ...
   @Test
   public void test_inflate_LayoutInflater_ViewGroup_boolean_2_293() {
      AccessPointViewPopupBinding var1 = AccessPointViewPopupBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), false);
   }
}
