...
public class VendorDetailsBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_513() {
      VendorDetailsBinding var1 = VendorDetailsBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), false);
   }
}
