...
public class RepositoryTestFailed {
   ...
   public void test_defaultValues_Context_int_boolean_1_1961() {
      ((Repository)JMockK.spyk(new Repository((Context)JMockK.mockk(Context.class, true)))).defaultValues((Context)JMockK.mockk(Context.class, true), 52, false);
   }
   ...
   public void test_stringAsInteger_int_int_1_1869() {
      int var1 = ((Repository)JMockK.spyk(new Repository((Context)JMockK.mockk(Context.class, true)))).stringAsInteger(-43, 93);
   }
}
