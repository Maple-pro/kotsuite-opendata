...
public class MainActivityBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_681() {
      MainActivityBinding var1 = MainActivityBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), true);
   }
}
