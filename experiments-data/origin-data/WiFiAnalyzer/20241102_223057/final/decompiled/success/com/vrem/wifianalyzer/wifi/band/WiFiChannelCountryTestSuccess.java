...
public class WiFiChannelCountryTestSuccess {
   ...
   public void test_channelAvailableGHZ2_int_1_2488() {
      Object var1 = ((WiFiChannelCountry)JMockK.spyk(new WiFiChannelCountry((Locale)JMockK.mockk(Locale.class, true)))).channelAvailableGHZ2(4);
      Assert.assertEquals(new Integer(1), var1);
   }

   @Test
   public void test_channelAvailableGHZ5_int_1_2500() {
      Object var1 = ((WiFiChannelCountry)JMockK.spyk(new WiFiChannelCountry((Locale)JMockK.mockk(Locale.class, true)))).channelAvailableGHZ5(12);
      Assert.assertEquals(new Integer(0), var1);
   }

   @Test
   public void test_channelAvailableGHZ6_int_1_2512() {
      Object var1 = ((WiFiChannelCountry)JMockK.spyk(new WiFiChannelCountry((Locale)JMockK.mockk(Locale.class, true)))).channelAvailableGHZ6(-19);
      Assert.assertEquals(new Integer(0), var1);
   }
