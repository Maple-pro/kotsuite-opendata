...
public class DataManagerTestSuccess {
   ...
   public void test_addData_GraphViewWrapper_WiFiDetail_int_1_3432() {
      ((DataManager)JMockK.spyk(new DataManager((TimeGraphCache)JMockK.mockk(TimeGraphCache.class, true)))).addData((GraphViewWrapper)JMockK.mockk(GraphViewWrapper.class, true), (WiFiDetail)JMockK.mockk(WiFiDetail.class, true), 61);
   }

   @Test
   public void test_addSeriesData_GraphViewWrapper_List_int_1_3376() {
      Set var1 = ((DataManager)JMockK.spyk(new DataManager((TimeGraphCache)JMockK.mockk(TimeGraphCache.class, true)))).addSeriesData((GraphViewWrapper)JMockK.mockk(GraphViewWrapper.class, true), (List)JMockK.mockk(List.class, true), 84);
   }
