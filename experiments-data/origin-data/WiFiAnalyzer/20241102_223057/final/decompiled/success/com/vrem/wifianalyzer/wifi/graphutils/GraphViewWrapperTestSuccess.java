...
public class GraphViewWrapperTestSuccess {
   ...
   public void test_setViewport_int_int_1_3728() {
      ((GraphViewWrapper)JMockK.spyk(new GraphViewWrapper((GraphView)JMockK.mockk(GraphView.class, true), (GraphLegend)JMockK.mockk(GraphLegend.class, true), (ThemeStyle)JMockK.mockk(ThemeStyle.class, true), (SeriesCache)JMockK.mockk(SeriesCache.class, true), (SeriesOptions)JMockK.mockk(SeriesOptions.class, true)))).setViewport(54, -56);
   }

   @Test
   public void test_size_int_1_3932() {
      Object var1 = ((GraphViewWrapper)JMockK.spyk(new GraphViewWrapper((GraphView)JMockK.mockk(GraphView.class, true), (GraphLegend)JMockK.mockk(GraphLegend.class, true), (ThemeStyle)JMockK.mockk(ThemeStyle.class, true), (SeriesCache)JMockK.mockk(SeriesCache.class, true), (SeriesOptions)JMockK.mockk(SeriesOptions.class, true)))).size(7);
   ...
   public void test_visibility_int_1_3904() {
      ((GraphViewWrapper)JMockK.spyk(new GraphViewWrapper((GraphView)JMockK.mockk(GraphView.class, true), (GraphLegend)JMockK.mockk(GraphLegend.class, true), (ThemeStyle)JMockK.mockk(ThemeStyle.class, true), (SeriesCache)JMockK.mockk(SeriesCache.class, true), (SeriesOptions)JMockK.mockk(SeriesOptions.class, true)))).visibility(-44);
   }
}
