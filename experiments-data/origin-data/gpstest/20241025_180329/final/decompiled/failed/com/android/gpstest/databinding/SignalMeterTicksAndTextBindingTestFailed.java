...
public class SignalMeterTicksAndTextBindingTestFailed {
   ...
   @Test
   public void test_inflate_LayoutInflater_ViewGroup_boolean_2_1517() {
      SignalMeterTicksAndTextBinding var1 = SignalMeterTicksAndTextBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), true);
   }
}
