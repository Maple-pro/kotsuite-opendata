...
public class BenchmarkMotionLayoutBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_1597() {
      BenchmarkMotionLayoutBinding var1 = BenchmarkMotionLayoutBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), true);
   }
}
