...
public class QrCodeInstructionsBindingTestFailed {
   ...
   @Test
   public void test_inflate_LayoutInflater_ViewGroup_boolean_2_1881() {
      QrCodeInstructionsBinding var1 = QrCodeInstructionsBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), true);
   }
}
