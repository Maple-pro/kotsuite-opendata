...
public class CsvFileLoggerTestFailed {
   ...
   public void test_onOrientationChanged_Orientation_long_long_1_165() {
      ((CsvFileLogger)JMockK.spyk(new CsvFileLogger((Context)JMockK.mockk(Context.class, true)))).onOrientationChanged((Orientation)JMockK.mockk(Orientation.class, true), 77L, -24L);
   }
}
