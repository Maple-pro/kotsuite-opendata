...
public class ActivityHelpBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_1681() {
      ActivityHelpBinding var1 = ActivityHelpBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), true);
   }

   @Test
   public void test_inflate_LayoutInflater_ViewGroup_boolean_2_1685() {
