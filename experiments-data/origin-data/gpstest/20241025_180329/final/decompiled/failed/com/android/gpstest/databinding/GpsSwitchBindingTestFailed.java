...
public class GpsSwitchBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_1233() {
      GpsSwitchBinding var1 = GpsSwitchBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), false);
   }
}
