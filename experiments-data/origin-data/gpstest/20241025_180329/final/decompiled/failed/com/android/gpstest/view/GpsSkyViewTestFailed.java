...
public class GpsSkyViewTestFailed {
   ...
   public void test_getSatelliteColor_float_1_1177() {
      int var1 = ((GpsSkyView)JMockK.spyk(new GpsSkyView((Context)JMockK.mockk(Context.class, true)))).getSatelliteColor(67.792694F);
   }

   @Test
   public void test_onOrientationChanged_double_double_1_1189() {
      ((GpsSkyView)JMockK.spyk(new GpsSkyView((Context)JMockK.mockk(Context.class, true)))).onOrientationChanged(49.398901689106054, 28.504566818421807);
   }
