...
public class CsvFileLoggerTestSuccess {
   ...
   public void test_onNmeaReceived_long_String_1_137() {
      ((CsvFileLogger)JMockK.spyk(new CsvFileLogger((Context)JMockK.mockk(Context.class, true)))).onNmeaReceived(26L, "VXf2dv13X+z6oy-YXmWxMADH59IHjHfDrbRokpk91gbG0V8WKM9T");
   }
}
