...
public class ClearAssistWarningBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_1849() {
      ClearAssistWarningBinding var1 = ClearAssistWarningBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), true);
   }

   @Test
   public void test_inflate_LayoutInflater_ViewGroup_boolean_2_1853() {
