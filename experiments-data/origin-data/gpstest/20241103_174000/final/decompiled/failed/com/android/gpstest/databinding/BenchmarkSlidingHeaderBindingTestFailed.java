...
public class BenchmarkSlidingHeaderBindingTestFailed {
   ...
   @Test
   public void test_inflate_LayoutInflater_ViewGroup_boolean_2_1321() {
      BenchmarkSlidingHeaderBinding var1 = BenchmarkSlidingHeaderBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), false);
   }
}
