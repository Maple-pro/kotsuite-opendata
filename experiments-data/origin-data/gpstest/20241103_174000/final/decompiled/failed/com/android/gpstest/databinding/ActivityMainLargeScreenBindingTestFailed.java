...
public class ActivityMainLargeScreenBindingTestFailed {
   ...
   public void test_inflate_LayoutInflater_ViewGroup_boolean_1_1737() {
      ActivityMainLargeScreenBinding var1 = ActivityMainLargeScreenBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), true);
   }

   @Test
   public void test_inflate_LayoutInflater_ViewGroup_boolean_2_1741() {
