...
public class NavdrawerSeparatorBindingTestSuccess {
   ...
   @Test
   public void test_inflate_LayoutInflater_ViewGroup_boolean_2_1377() {
      NavdrawerSeparatorBinding var1 = NavdrawerSeparatorBinding.inflate((LayoutInflater)JMockK.mockk(LayoutInflater.class, true), (ViewGroup)JMockK.mockk(ViewGroup.class, true), false);
   }
}
